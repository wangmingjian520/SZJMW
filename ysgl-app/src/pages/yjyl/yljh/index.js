...
export default class Yljh extends React.Component{
    state={
        dataSource:[],
        footer:'',
    }
    ...
    requestList = ()=>{
        let _this =this;
        axios.requestList(_this,FaceUrl.yljh,FaceUrl.POST,FaceUrl.bdApi,this.params);
    }
        ...
        return (
            <div>
                <Breadcrumb separator=">" style={{ margin: '16px 20px' }}>
                    ...
                    <Breadcrumb.Item>演练计划</Breadcrumb.Item>
        ...
        return (
            <Form layout="horizontal">
                ...
                <FormItem label="演练地点" {...formItemLayout}>
                   { 
                       tableInfo && type=='detail'? tableInfo.ylAddr: 
                       getFieldDecorator('ylAddr',{
                        initialValue:tableInfo.ylAddr,
                        rules:[
                            {
                                required: true,
                                message:'请输入演练地点'
                        ...
                        (<Input placeholder="请输入演练地点" maxlength="200"/>
                        )
                    }
                ...
                <FormItem label="演练要求" {...formItemLayout}>
                   { 
                       tableInfo && type=='detail'? tableInfo.ylyq: 
                       getFieldDecorator('ylyq',{
                            initialValue:tableInfo.ylyq,
                            
                        })(
                        <Input placeholder="请输入演练要求" maxlength="200"/>
                        )
                    }
