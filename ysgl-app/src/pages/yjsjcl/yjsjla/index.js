...
export default class Yjsjla extends React.Component{
    ...
    requestList = ()=>{
        let _this =this;
        axios.requestList(_this,FaceUrl.sjla,FaceUrl.POST,FaceUrl.bdApi,this.params);
    }
        ...
        const columns = [
            {
            ...
            },
             {
                 ...
                 align:'center',
                 render(laDate){
                    return moment(laDate).format('YYYY-MM-DD')
                 }
             },
             {
                 title:'立案总结',
        ...
        return (
            <Form layout="horizontal">
                ...
                <FormItem label="应急事件编号" {...formItemLayout}>
                   { 
                       ...
                       getFieldDecorator('jbCode',{
                        ...
                        <Input placeholder="请输入应急事件编号" maxlength="20"/>
                        )
                    }
                ...
                <FormItem label="立案时间" {...formItemLayout}>
                   { 
                       tableInfo && type=='detail'? tableInfo.laDate: 
                       getFieldDecorator('laDate',{
                        initialValue:moment(tableInfo.laDate),
                    })
                        (<DatePicker  />
                        )
                    }
                ...
                <FormItem label="立案总结" {...formItemLayout}>
                    {   
                        tableInfo && type=='detail'? tableInfo.lazj: 
                        getFieldDecorator('lazj',{
                            initialValue:tableInfo.lazj,
                            rules:[]
                        })(
                            <TextArea style={{ width: 526 }}
                            autosize={{minRows:3}}
