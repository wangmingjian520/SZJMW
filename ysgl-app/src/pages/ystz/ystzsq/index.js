...
export default class Ystzsq extends React.Component{
    state={
        dataSource:[],
        footer:'',
    }
    ...
    requestList = ()=>{
        let _this =this;
        axios.requestList(_this,FaceUrl.ystzsqgl,FaceUrl.POST,FaceUrl.bdApi,this.params);
    }
        ...
        return (
            <div>
                <Breadcrumb separator=">" style={{ margin: '16px 20px' }}>
                    ...
                    <Breadcrumb.Item>预算调整</Breadcrumb.Item>
                    <Breadcrumb.Item>预算调整申请</Breadcrumb.Item>
                </Breadcrumb>
                ...
                <FormItem label="填报人" {...formItemLayout}>
                   { 
                       ...
                       getFieldDecorator('tbr',{
                        ...
                        <Input placeholder="请输入填报人" />
                        )
                    }

                </FormItem>
                <FormItem label="填报时间" {...formItemLayout}>
                    {   
